...
Deploy [deploy.yml](https://github.com/Dimokus88/Acrechain/blob/main/deploy.yml) **Acrechain** nodes with **Cloudmos (Akashlytics)** ( [use instructions here](https://github.com/Dimokus88/guides/blob/main/Akashlytics/EN-guide.md) ) by setting the values ​​in the corresponding `deploy.yml` variables:
...
### Creating an Acrechain validator
...
[Back to top](https://github.com/Dimokus88/Acrechain/blob/main/README.md#Acrechain-validator-node-on-akash-network)
...
Разверните [deploy.yml](https://github.com/Dimokus88/Acrechain/blob/main/deploy.yml) ноды **Acrechain** с помощью **Cloudmos (Akashlytics)**  ([инструкция по использованию здесь](https://github.com/Dimokus88/guides/blob/main/Akashlytics/RU-guide.md)) установив значения в соответствующих переменных  `deploy.yml`: 
...
[К началу](https://github.com/Dimokus88/Acrechain/blob/main/README.md#Acrechain-validator-node-on-akash-network)
